...
if(isset($_POST["submit"])){	
		...
		if($inserted_user_id){
			...
			$recruiter->description 	= trim($_POST['comp_desc']);
        ...
        <tr valign="top"><td width="100%">
            ...
            <table cellpadding="6" border="0" width="100%" class='normalTxt infotbl'>    
                ...
                <tr><td><label><strong>Website</strong></label></td>
                	<td><input type="text" name="website" id="website" size="40"/></td></tr>
                <tr><td><label><strong>Logo URL</strong></label></td>
                	<td><input type="text" name="logo_url" id="logo_url" size="40"/></td></tr>                                                
                <tr valign="middle"><td colspan="2"><label><strong>Company Description</strong></label><br/>
                 	<textarea name="comp_desc" id="comp_desc" cols="60" rows="5"></textarea></td></tr>
                ...
                <?php 
                      while($year = array_shift($years))
                      	echo"&nbsp;&nbsp;&nbsp;<input type='radio' id='for_year' name='for_year' value='{$year}' /> {$year} "; 
                ?>
