...
if(isset($_POST["submit"])){
	...
	$student = new Student();
	if(isset($_POST['mail_announce'])) $student->mail_announce=1; else $student->mail_announce=0;
	
	if(Student::updateSettingByID($student))
		$msg4 = "<span class='smallTxt errnot'>[Updated]</span>";
}
...
<?php if(isset($msg)) echo"<tr><td>{$msg}</td></tr>"; ?>       
    ...
    <tr><td>
        ...
        <tr><td width="70%">
            ...
            <?php $stud = Student::getDetailByID($session->user_id); ?>
                ...
                <tr class="highlighter"><td colspan="2"><?php if(isset($msg4)) echo $msg4." - "; ?> Other Options</td></tr>
                <tr><td colspan="2">
                	
                    <table cellpadding="0">
                    <tr><td><input type="checkbox" name="mail_announce" value="1" 
                    		<?php if($stud->mail_announce==1) echo"checked='checked'";?> /></td>
                    	<td>&nbsp;&nbsp;Send me announcements as an email.</td></tr>
                    </table>
